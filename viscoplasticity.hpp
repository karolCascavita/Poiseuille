...
public:
    ...
    auto  at_all_faces(void) {  return c_face_tensor_vector;}

    auto  at_all_cells(void) const {  return cell_tensor_vector;}
    auto  at_all_faces(void) const {  return c_face_tensor_vector;}
...
public:
                ...
                //WK: for mu as tensor one should check this part
    {
        ...
        face_quadrature  = face_quadrature_type(2 * degree + 2);
