...
public:
    ...
    struct errors
    {
        ...
        {
            dof  = 0.; fun = 0.; dfun = 0.; dof_sigma = 0.;
            return;
        }
                    ...
                    const size_t          imsh)
    {
        ...
        for(size_t iter = 0; iter < m_max_iters ; iter++)
        {
            ...
            //tc_detail.toc();
            //timings["Solver"] += tc_detail.to_double();
